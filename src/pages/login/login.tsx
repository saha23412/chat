...
import { loginValidationRequired, passwordValidationRequired } from '../../validation/validation-required'
                ...
                //     </div>
                    (
                        <div className='SignIn-form'>
                            <Typography variant='h5' component="div" className="SignIn-form-title">
                                Войти
                            </Typography>
                            <Typography variant='subtitle1' component="div" gutterBottom={true} className="SignIn-form-subtitle">
                            ...
                            <form onSubmit={handleSubmit(onSubmitForm)}>
                                ...
                                <Typography className='SignIn-form-error'>{error ? error : null}</Typography>
                                <Prompt path='/' question='У вас еще нет аккаунта?' linkText='Пройдите аутентификацию' />
                            </form>
                        </div>
                    )
            }
